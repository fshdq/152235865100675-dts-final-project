...
const HeaderDetail = ({ data }) => {
  return (
    <div className="flex flex-col gap-y-2 sm:flex-row lg:items-center lg:justify-between">
      <div className="flex-1 min-w-0">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl md:text-6xl">
          {data?.name}
        </h1>
        <div className="pt-2 flex space-x-2 flex-row sm:flex-wrap sm:mt-0 sm:space-x-4">
          ...
          <div className="flex justify-center font-bold gap-x-2 h-8 p-2 rounded-full items-center text-sm text-zinc-500">
